 ...
 */
    ...
    //Add a Movie 
    public void create(String name,String genre,String year,String description, String runtime,String imgurl,String vidurl) throws SQLException {
    ...
    public void update(String name, String genre, String year,String description, String runtime, String imgurl,String vidurl, int ID) throws SQLException{
